...
此示例提供了如何使用FSMC固件库和关联驱动程序对安装在STM3210E-EVAL板上的IS61WV51216BLL SRAM存储器执行读/写操作的基本示例。

@par Directory contents  目录内容

  - FSMC/SRAM/stm32f10x_conf.h    Library Configuration file  库配置文件
  - FSMC/SRAM/stm32f10x_it.c      Interrupt handlers  中断处理程序
  - FSMC/SRAM/stm32f10x_it.h      Header for stm32f10x_it.c    
  - FSMC/SRAM/main.c              Main program
  - FSMC/SRAM/system_stm32f10x.c  STM32F10x system source file  STM32F10x系统源文件
