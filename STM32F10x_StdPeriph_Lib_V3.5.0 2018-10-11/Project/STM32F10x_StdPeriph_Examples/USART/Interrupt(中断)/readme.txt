...
此示例使用中断提供USARTy和USARTz之间的基本通信。  USART和USARTz可以是USART1和USART2
或USART2和USART3，具体取决于您使用的STMicroelectronics EVAL板。

USARTz将TxBuffer2发送到USARTy，后者将TxBuffer1发送到USARTz。  USARTy和USARTz收到的数
据分别存储在RxBuffer1和RxBuffer2中。 数据传输在USARTy_IRQHandler和stm32f10x_it.c文件中的
USARTz_IRQHandler中进行管理。
