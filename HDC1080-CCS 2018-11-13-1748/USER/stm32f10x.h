...
#define FLASH_BASE            ((uint32_t)0x08000000) /*!< 别名区域中的FLASH基址 */
#define SRAM_BASE             ((uint32_t)0x20000000) /*!< 别名区域中的SRAM基址 */
#define PERIPH_BASE           ((uint32_t)0x40000000) /*!< 别名区域中的外设基址 */

#define SRAM_BB_BASE          ((uint32_t)0x22000000) /*!< 位带区域中的SRAM基址*/
#define PERIPH_BB_BASE        ((uint32_t)0x42000000) /*!< 位带区域中的外设基址 */
